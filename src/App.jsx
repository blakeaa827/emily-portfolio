...
const SHUFFLER_CARDS = [
  ...
  { id: 3, title: "Sam Houston State University Alum", desc: "B.S. in Animal Science • Huntsville, Texas", icon: ClipboardList }
];
      ...
      <div>
        ...
        <div className="space-y-6 relative before:absolute before:left-3 before:top-2 before:bottom-2 before:w-px before:bg-moss/20">
          ...
          <div className="relative pl-8 group">
            ...
            <p className="font-serif italic text-lg text-charcoal">B.S. in Animal Science • Sam Houston State University</p>
          </div>
        </div>
      </div>
    </div>
